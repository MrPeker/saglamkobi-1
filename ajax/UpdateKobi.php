...
if($_POST) {
	...
	MySqlQuery("Update kobis set name='$name',sector_id='$sector_id',type='$type',status='$status',needs='$needs',description='$description',updated_at='".date("Y-m-d H:i:s")."' where id='$id'",array());
